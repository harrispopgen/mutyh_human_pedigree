...
#$ -o /net/harris/vol1/home/clyoung1/myh_pedigree/230705_fullpipeline/PossibleDeNovo_files/redo_filtered_vcfs/errors
#$ -e /net/harris/vol1/home/clyoung1/myh_pedigree/230705_fullpipeline/PossibleDeNovo_files/redo_filtered_vcfs/errors
#$ -m bea
#$ -M clyoung1@uw.edu
#$ -P sage

##### filter original VCF for umap100 mappable regions, AVERAGED accessible regions of genome (12 < average 10KB window depth generated by samtools depth > 120) and exclude centromere/telomere regions #####
